...
public interface Configuration_jsp {
  ...
  public static final String NOM_FICHIER_ERROR = "error.jsp";

  public static final String URL_BASE_JSP = Configuration_base.URL_BASE_PROJET + "/" + NOM_DOSSIER_JSP;
  public static final String URL_BASE_JSP_DEPUIS_PROJET = "/" + NOM_DOSSIER_JSP;
  ...
  public static final String URL_ERROR = URL_BASE_JSP + "/" + NOM_FICHIER_ERROR;
  public static final String URL_ERROR_DEPUIS_PROJET = URL_BASE_JSP_DEPUIS_PROJET + "/" + NOM_FICHIER_ERROR;
  ...
  public static final String URL_BASE_JSP_PROTEGE_ADMINISTRATEUR_DEPUIS_PROJET = URL_BASE_JSP_PROTEGE_DEPUIS_PROJET + "/" + NOM_DOSSIER_PROTEGER_ADMINISTRATEUR;

  public static final String URL_BASE_JSP_PROTEGE_CLIENT = URL_BASE_JSP_PROTEGE + "/" + NOM_DOSSIER_PROTEGER_CLIENT;
  public static final String URL_BASE_JSP_PROTEGE_CLIENT_DEPUIS_PROJET = URL_BASE_JSP_PROTEGE_DEPUIS_PROJET + "/" + NOM_DOSSIER_PROTEGER_CLIENT;
  ...
  public static final String URL_BASE_IMAGES = URL_BASE_ASSETS + "/" + NOM_DOSSIER_IMAGES;
}
