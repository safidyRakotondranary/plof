...
CREATE TABLE administrateur(
	...
	PRENOM_ADMINISTRATEUR varchar(100),
	SEXE_ADMINISTRATEUR char,
	MAIL_ADMINISTRATEUR varchar(100),
	MDP_ADMINISTRATEUR varchar(100),
	PHOTO_PROFIL_ADMINISTRATEUR varchar(100)
);
CREATE TABLE menu(
...
CREATE TABLE attribut_menu(
  ...
  ID_PARENT_ATTRIBUT_MENU integer REFERENCES attribut_menu(ID_ATTRIBUT_MENU)
);
